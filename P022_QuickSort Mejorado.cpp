...
// Descripción: Programa con menú interactivo que aplica Quick Sort a un archivo (Mejorado con pivote aleatorio)
...
// Funciones para Quick Sort mejorado
int particion(int arr[], int inicio, int fin) {
    // Elegir índice aleatorio entre inicio y fin
    int pivoteale = inicio + rand() % (fin - inicio + 1);
    swap(arr[pivoteale], arr[fin]); // Intercambiar con último elemento
